...
# 预处理参数
CPPLFAGS=-I./include 																	\
					-I/usr/data/bxm/try/Distributed-storage/include/fastdfs/			\
					-I/usr/data/bxm/try/Distributed-storage/include/fastommon/			\
					-I/usr/data/bxm/try/Distributed-storage/local/include/hiredis/		\
					-I/usr/data/bxm/try/Distributed-storage/include/mysql/				
...
# 生成每一个子目标
# main程序
$(main):${TEST_PATH}/main.o ${TEST_PATH}/fdfs_api.0 $(COMMON_PATH)/make_log.o
		$(CC) $^ $(LIBS) -o $@
...
$(myfiles):				$(CGI_SRC_PATH)/myfiles_cgi.o 		\
			...
			$(CC) $^ -o $@ $(LIBS) 
# 分享，删除文件，pv字段处理
$(dealfile):			$(CGI_SRC_PATH)/dealfile.o 			\
						$(COMMON_PATH)/make_log.o			\
						$(COMMON_PATH)/util_cgi.o 			\
						$(COMMON_PATH)/cJSON.o 				\
						$(COMMON_PATH)/deal_mysql.o 		\
